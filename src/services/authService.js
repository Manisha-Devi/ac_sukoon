...
class AuthService {
  ...
  async sendOtherPaymentForApproval(data) {
    try {
      console.log('📝 Sending other payment for approval:', data);
      ...
      const response = await fetch(this.API_URL, {
        ...
        redirect: 'follow',
        body: JSON.stringify({
          action: 'sendOtherPaymentForApproval',
          entryId: data.entryId
        })
      });
      ...
      const result = await response.json();
      console.log('✅ Other payment sent for approval:', result);
      return result;
    } catch (error) {
      console.error('❌ Error sending other payment for approval:', error);
      return { success: false, error: error.message };
    }
  }
  ...
  async approveOtherPayment(data) {
    try {
      console.log('✅ Approving other payment:', data);
      ...
      const response = await fetch(this.API_URL, {
        ...
        body: JSON.stringify({
          ...
          entryId: data.entryId,
          approvedBy: data.approvedBy // Include the approver's name
        })
      });
      ...
      const result = await response.json();
      console.log('✅ Other payment approved:', result);
      return result;
    } catch (error) {
  ...
  async rejectOtherPayment(data) {
    try {
      console.log('❌ Rejecting other payment:', data);
      ...
      const response = await fetch(this.API_URL, {
        ...
        redirect: 'follow',
        body: JSON.stringify({
          action: 'rejectOtherPayment',
          entryId: data.entryId,
          rejectedBy: data.rejectedBy // Include the rejecter's name
        })
      });
      ...
      const result = await response.json();
      console.log('❌ Other payment rejected:', result);
      return result;
    } catch (error) {
      console.error('❌ Error rejecting other payment:', error);
      return { success: false, error: error.message };
    }
  }
