  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingEntry) {
        ...
        setFormData({ cashAmount: "", bankAmount: "", liters: "", rate: "", date: "", pumpName: "", remarks: "" });
        setIsLoading(false);
...
```// The FuelEntry component is updated to include a remarks field in the form, handle it in form submissions, editing, and displaying the remarks in the recent entries.
import React, { useState, useEffect } from "react";
import "../css/FuelPayment.css";
import authService from '../../services/authService.js';
