...
function ProfitChart({ 
  ...
  if (process.env.NODE_ENV === 'development') {
    console.log('📊 ProfitChart loaded with', fareData.length, 'fare entries and', expenseData.length, 'expense entries');
  }
  ...
  const analytics = useMemo(() => {
    ...
    let totalFilteredExpenses = fuelExpenses + addaExpenses + unionExpenses + serviceExpenses + otherExpenses + foodExpenses;
  ...
  const expenseBreakdownData = useMemo(() => ({
    labels: ['⛽ Fuel', '🏪 Adda', '🤝 Union', '🔧 Service', '📦 Other', '🍽️ Food'],
    datasets: [
      {
        data: [
  ...
  return (
    <div className="fade-in">
      ...
      <div className="profit-chart-header">
        ...
        <p>Comprehensive profit data analysis and insights</p>
      ...
      {showFilter && (
        <div className="profit-chart-filter-section">
